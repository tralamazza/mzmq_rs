//! ZMTP 3.1 PUB connection state machine.
...
#[cfg_attr(
    feature = "plain",
    doc = "      [`Connection::new_plain`] for the PLAIN mechanism."
)]
#[cfg_attr(
    not(feature = "plain"),
    doc = "      or construct via [`Connection::new`]."
)]
...
mod tests {
    ...
    // Test 20: calling write_greeting twice fails
    #[test]
    ...
    // Test 21: invalid signature in partial greeting fails fast
    #[test]
    ...
    // Test 24: partial check fires exactly once; valid greeting split at the boundary
    #[test]
    ...
    // Test 25: write_greeting produces the canonical 64-byte greeting
    #[test]
    ...
    // Test 26: feed in Failed state returns WrongState
    #[test]
    ...
    mod plain_tests {
        ...
        // Test P1: write_greeting for PLAIN encodes "PLAIN" and as_server=1
        #[test]
